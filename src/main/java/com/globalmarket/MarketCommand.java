...
public class MarketCommand implements TabExecutor {
    ...
    private void handleCreateCommand(Player player, String[] args) {
        ...
        try {
            ...
            // 验证物品是否可以上架
            com.globalmarket.util.ItemValidator.ValidationResult itemValidationResult = 
                com.globalmarket.util.ItemValidator.canListItem(sellItem);
            
            if (!itemValidationResult.isAllowed()) {
                player.sendMessage(ChatColor.RED + "物品验证失败: " + itemValidationResult.getMessage());
                return;
            }
